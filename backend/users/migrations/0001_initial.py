    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_3', models.EmailField(blank=True, max_length=100, null=True)),
                ('public_email', models.EmailField(blank=True, max_length=100, null=True, unique=True)),
                ('notification_email', models.EmailField(blank=True, max_length=100, null=True)),
