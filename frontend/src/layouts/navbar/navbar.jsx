...
import NavDrawerWrapper from './navDrawer'
				...
				<ul className='nav-links'>
					{context.tokens?.access ? (
						<>
							...
							<li className='link explore' onClick={() => explore()} title='Explore'>
							...
							<li className='link create-post' onClick={() => post()} title='Compose Post'>
								<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'>
							...
							<li className='link notifications pos-relative' title='Notifications'>
								<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'>
								...
								<span className=' pos-absolute top-10-px right-3-px badge width-10-px height-10-px br-full red'></span>
							</li>
					...
					<Dropdown
						button={
							<div
								...
								title={`${context.user.full_name?.toUpperCase() || context.user.username.toUpperCase()} \nStatus: ${onlineStatus ? 'Online' : 'Offline'}`}>
								<img className='' src={CELESUP_BASE_URL + context.user.avatar} alt='' />
								{onlineStatus && <span className='online__status pos-absolute left-1-rem  bottom-neg-5-px width-1-rem height-2-px lime' style={{ backgroundColor: 'lime' }}></span>}
							</div>
						}
						items={[
