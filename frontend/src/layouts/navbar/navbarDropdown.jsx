...
const NavbarDropdown = () => {
	...
	return (
		<div className='navbar-dropdown card bg-color z-index-1'>
			<ul className='text-color d-flex flex-column align-items-end'>
				<li className='m-1 mt-0 mb-0 p-1 link-item' onClick={() => dropDownDecorator(userAccount)}>
					Profile
				</li>
				<li className='m-1 mb-0 p-1' onClick={() => dropDownDecorator(toggleTheme)}>
					Settings
				</li>
				<li className='m-1 mb-0 p-1' onClick={() => dropDownDecorator(logoutUser)}>
					Logout
				</li>
