...
const InputPasswordField = ({updateForm, placeholder='password', fieldName='password'}) => {
  ...
  return (
    <div>
      <div className="input-field">
          <input autoComplete='off' required type="password" name={fieldName}placeholder={placeholder} onChange={passwordChanged}/>
          <span className="show-password d-none" title="show password" ref={showPass} onClick={showPassword}>
            { isShow ?
            <>
