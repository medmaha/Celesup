...
var defaultImageStyles = {
    brightness:{value:100, prefix:'%'}, saturate:{value:100, prefix:'%'},
    contrast:{value:100, prefix:'%'}, blur:{value:0, prefix:'px'},
    sepia:{value:0, prefix:'%'}, grayscale:{value:0, prefix:'%'},
...
const ImageEditor = ({image, previewDefaultImage}) => {
    ...
    function chooseFilter ({currentTarget}){
        ...
        if (selectedFilter && 
                selectedFilter.getAttribute('data-filter') === currentTarget.getAttribute('data-filter')
            )return
    ...
    return (
        <div className='post-editor mx-3 text-center height-4-rem'>
            <span className="mt-2 hide">
                <input ref={slider} type="range" min={0} max={200} onChange={handleSliderChange}/>
            </span>
            
            <div className="post-edit-filters d-flex justify-content-between pt-2">
                <span data-filter='brightness' data-unit='%' data-index='0' data-min='0' data-max='200' data-value='100' onClick={chooseFilter}>
                ...
                <span data-filter='saturate' data-unit='%' data-index='1' data-min='0' data-max='200' data-value='100' onClick={chooseFilter}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px">
                        <path d="M12,4.81L12,19c-3.31,0-6-2.63-6-5.87c0-1.56,0.62-3.03,1.75-4.14L12,4.81 M6.35,7.56L6.35,7.56C4.9,8.99,4,10.96,4,13.13 C4,17.48,7.58,21,12,21c4.42,0,8-3.52,8-7.87c0-2.17-0.9-4.14-2.35-5.57l0,0L12,2L6.35,7.56z" /></svg>
                </span>
                <span data-filter='hue-rotate' data-unit='deg' data-index='2' data-min='0' data-max='100' data-value='0' onClick={chooseFilter}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px">
                ...
                <span data-filter='sepia' data-unit='%' data-index='3' data-min='0' data-max='100' data-value='0' onClick={chooseFilter}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px">
                        <path d="M19 9l1.25-2.75L23 5l-2.75-1.25L19 1l-1.25 2.75L15 5l2.75 1.25L19 9zm-7.5.5L9 4 6.5 9.5 1 12l5.5 2.5L9 20l2.5-5.5L17 12l-5.5-2.5zM19 15l-1.25 2.75L15 19l2.75 1.25L19 23l1.25-2.75L23 19l-2.75-1.25L19 15z" /></svg>
                </span>
                <span data-filter='contrast' data-unit='%' data-index='4' data-min='0' data-max='100' data-value='100' onClick={chooseFilter}>
                    <svg xmlns="http://www.w3.org/2000/svg"  height="24px" viewBox="0 0 24 24" width="24px">
                        <path d="M20 15.31L23.31 12 20 8.69V4h-4.69L12 .69 8.69 4H4v4.69L.69 12 4 15.31V20h4.69L12 23.31 15.31 20H20v-4.69zM12 18V6c3.31 0 6 2.69 6 6s-2.69 6-6 6z" /></svg>
                </span>
                <span data-filter='blur' data-unit='px' data-index='5' data-min='0' data-max='100' data-value='0'  onClick={chooseFilter}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px">
                ...
                <span data-filter='grayscale' data-unit='%' data-index='6' data-min='0' data-max='100' data-value='0' onClick={chooseFilter}>
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px">
                        <path d="M12,22c5.52,0,10-4.48,10-10S17.52,2,12,2S2,6.48,2,12S6.48,22,12,22z M13,4.07c3.94,0.49,7,3.85,7,7.93s-3.05,7.44-7,7.93 V4.07z" /></svg>
                </span>
            </div>
        </div>
    )
