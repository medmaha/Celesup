...
const Hashtag = ({ onChange, placeholder, name, autoComplete = 'off', autoCorrect = 'off', classes = '' }) => {
	...
	return (
		<span className='d-block'>
			<input ref={instance} className={classes} autoCorrect={autoCorrect} value={hashtags} type='text' onChange={handleTagChange} placeholder={placeholder} autoComplete={autoComplete} />
		</span>
	)
}
