...
const ImageEditor = ({ image, previewDefaultImage }) => {
	...
	function chooseFilter({ currentTarget }) {
		...
		if (selectedFilter && selectedFilter.getAttribute('data-filter') === currentTarget.getAttribute('data-filter')) return
	...
	return (
		<div className='d-flex flex-column  justify-content-evenly px-2 text-center theme-primary height-4-rem'>
