...
const ComposePost = ({ context, reFetchPosts }) => {
    ...
    return (
        ...
        >
            ...
            <div className="post__items d-flex flex-column gap-10-px">
                <div
                    id="inputField"
                    className="height-3-rem bg-color text-muted justify-content-center border d-flex align-items-center px-1 cursor-pointer grey-text"
                    style={{
                        borderRadius: "1.5rem",
                ...
                <div className="d-flex align-items-center cursor-pointer width-max-content">
                    ...
                    <span className="d-inline-block font-sm">
                        Attach A File
                    </span>
                </div>
            </div>
