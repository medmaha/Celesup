...
const ComposePost = ({ context, reFetchPosts }) => {
    ...
    return (
        <article className="compose__new__post d-flex justify-content-center mb-1">
            <section className="br-md d-flex card p-1 align-items-center gap-1-rem width-550-px">
                ...
                <div className="post__items width-100 d-flex flex-column gap-1-rem">
                    <span className="d-block">
                        <div
                            className="height-3-rem bg-color truncate border w-full d-flex align-items-center pl-1 cursor-pointer grey-text"
                            style={{
                                borderRadius: "1.5rem",
