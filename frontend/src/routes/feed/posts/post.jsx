...
export default function Post({ post }) {
    ...
    function gotoAuthorProfile() {
        ...
        navigate(`/${postData.author.username}`)
    }
    ...
    return (
        <article className="post">
            ...
            <div className="d-flex align-items-center justify-content-between pb-__">
                ...
                >
                    <div className="profile-img">
                        <img
                            src={CELESUP_BASE_URL + postData.author.avatar}
                            alt=""
            ...
            <section className="pl-1" style={{ marginLeft: "40px" }}>
                ...
                {/* picture / video */}
                {postData.picture && (
                    <div className="picture d-flex pb-__">
                ...
                <div className="post__interactions">
                    ...
                    <div
                        className="interact d-flex justify-content-between align-items-center"
                        style={{ maxWidth: "350px" }}
                    >
                        <div
                            className="d-flex gap-5-px align-items-center likes cursor-pointer"
                            onClick={likePost}
                        >
                        ...
                        <div className="d-flex  gap-5-px align-items-center share cursor-pointer">
                            <span className="icon-wrapper">
                                <svg
                                    className="grey-icon cursor-pointer"
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div
                            className="d-flex  gap-5-px align-items-center comment cursor-pointer"
                        ...
                        >
                            ...
                            <span className="font-sm">Commet</span>
                        </div>
                        <div className="d-flex  gap-5-px align-items-center bookmark cursor-pointer">
                            <span className="icon-wrapper">
                                <svg
                                    className="grey-icon cursor-pointer"
                                    xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span className="font-sm">Bookmark</span>
                        </div>
                    </div>

                    {/* Comment Form */}
                    <PostComments post={post} toggle={postComments} />
