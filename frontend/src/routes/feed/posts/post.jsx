	...
	return (
		<article className='post'>
			...
			<div className='d-flex align-items-center justify-content-between pb-__'>
				<header onClick={gotoAuthorProfile} className='d-flex align-items-center justify-content-between'>
					<div className='profile-img'>
						<img src={CELESUP_BASE_URL + postData.author.avatar} alt='' className='cursor-pointer' />
					</div>
					<section className='username px-1 cursor-pointer'>
						{ismyPost ? (
							...
							<span>
								<b>{postData.author.full_name}</b> @{postData.author.username}
							</span>
						)}
						<p>
			...
			<section className='pl-1' style={{ marginLeft: '40px' }}>
				...
				{postData.picture && (
					<div className='picture d-flex pb-__'>
						<span className='post-image'>
							<img src={`${postData.picture}`} alt='file not supported' className='responsive br-md' />
						</span>
					</div>
				)}
				...
				<div className='post__interactions mt-1 '>
					...
					<div className='interact d-flex justify-content-between align-items-center' style={{ maxWidth: '300px' }}>
