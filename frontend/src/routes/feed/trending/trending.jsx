...
const Trending = () => {
	return (
		<section id='trendingFeed' className='width-35-rem width-100'>
			<article className='mx-1 mb-1'>
				<div className='card theme-primary br-lg d-flex flex-column align-items-center cursor-pointer'>
					...
					<p className='center font-sm'>Lorem ipsum dolor, sit amet ctetur adipisicing ipsum elit A aliquam! ctetur.</p>
				</div>
			</article>

			<article className='flat-card br-md mb-2 d-flex flex-column gap-1-rem'>
