                        ...
                        >
                            ...
                            {error && (
                                <div className="mt-1 d-flex justify-content-center">
                                    <span
                                        className="red-lighten-3 white-text px-1 py-__ br-sm"
                                        style={{ fontSize: ".9rem" }}
                                    >
                                        Invalid Code
                                    </span>
                            ...
                            <p className="px-3 py-1 text-center">
                                We've send a confirmation code to the email you
                                provided, Enter the code to continue
                            </p>
