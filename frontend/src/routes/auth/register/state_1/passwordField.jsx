...
function PasswordField({updateFormData, placeholder='password', fieldName='password'}) {
  ...
  return (
    <div>
      <div className="input-field">
          <input className='br-md' autoComplete='off' value={password} required type="password" name={fieldName} placeholder={placeholder} onChange={handlePasswordChange}/>
            {password.length > 0 &&
                <span className="show-password" title="show password" onClick={toggleShowPassword}>
                    {showPassword ?
                        <>
