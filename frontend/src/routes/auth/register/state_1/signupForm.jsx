...
const SignupForm = ({ userType }) => {
	...
	return (
		<>
			<form className='d-flex pt-2 justify-content-center'>
				<div className='card mx-__ br-md' style={{ maxWidth: '350px' }}>
					<h3 className='light-text center' style={{ letterSpacing: '2px' }}>
					...
					<div className='d-flex justify-content-center'>
						{pending ? (
							...
							<button className='btn-primary btn-large' onClick={submitForm}>
								<span>Signup</span>
			...
			<div className='d-flex justify-content-center font-md mt-2 cursor-pointer' onClick={gotoLoginRoute}>
				Already a member?
				<span className='teal-text-lighten-2 pl-__ hint-text  text-hover-blue-lighten-3'>Login</span>
			</div>
		</>
	)
}
