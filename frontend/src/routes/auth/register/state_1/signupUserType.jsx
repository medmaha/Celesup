		...
		<div className='d-flex justify-content-center pt-2'>
			<div className='card center' style={{ maxWidth: '400px' }}>
				...
				<div className='p-2 d-flex justify-content-around signup-options'>
					<span data-option='supporter' onClick={handleChoiceSelection} className='cursor-pointer blue py-__ px-2 d-flex flex-column align-items-center br-lg white-text font-lg'>
						<span>As a</span>
						<span>Supporter</span>
					</span>
					<span data-option='celebrity' onClick={handleChoiceSelection} className='ml-__ cursor-pointer green py-__ px-2 d-flex flex-column align-items-center br-lg white-text font-lg'>
						<span>I'm a</span>
						<span>Celebrity</span>
					</span>
				</div>
