	...
	return (
		<>
			<div className='d-flex justify-content-center align-items-center'>
				<div className='card mt-3 mx-__' style={{ maxWidth: '300px' }}>
					<h4 className='center'>Welcome To Celesup</h4>
					<h6 className='center py-__ ' style={{ letterSpacing: '2px' }}>
						LOGIN
					</h6>
					...
					<form onSubmit={submitForm} autoComplete='off'>
						...
						<div className='d-flex justify-content-right'>
							{pending ? (
								...
								<button className='btn br-md py-__ px-1'>
									<span>login</span>
			...
			<div className='d-flex justify-content-center align-items-center font-sm mt-2' onClick={gotoRegisterRoute}>
				New to Celesup?
				<span className='teal-text-lighten-2 pl-__ font-md cursor-pointer'>Signup</span>
			</div>
		</>
	)
}
