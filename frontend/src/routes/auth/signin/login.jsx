...
const Login = () => {
    ...
    return (
        <>
            ...
            <div
                className="d-flex justify-content-center align-items-center font-sm mt-2"
                onClick={gotoRegisterRoute}
            >
                New to Celesup?
                <span className="teal-text-lighten-2 pl-__ font-md cursor-pointer">
                    Signup
                </span>
            </div>
        </>
