const ProfileInformation = ({ profile }) => {
	return (
		<div className='profile__information card br-none pt-3 pos-relative pb-1'>
			<div className='row'>
				<div className='col-7-md px-2'>
					...
					<div className='d-flex align-items-center justify-content-between font-sm mt-1 mb-1 text-center'>
						<div>
							...
							<span className='mx-1 teal-text-lighten-3 cursor-pointer text-hover-blue-lighten-3'>
								Contact Info
							</span>
						</div>
				...
				<div className='col-12-sm col-5-md user__experience'>
					<div className='d-flex flex-column'>
						<div className=''>
							<h3 className='user__type text-center light-text'>
								{profile.user_type.toUpperCase()}
							</h3>
						</div>
						<div className='d-flex justify-content-right'>
							<p className='py-1'>
								Zoluptatem perspiciatis voluptas, recusandae possimus velit dolores.
								Officia alias voluptatem ut dolore hic sint asperiores soluta
								facere. Excepturi, asperiores? Adipisci, natus.
							</p>
						</div>
					</div>
				</div>
			...
			<div
				className='edit__profile__btn pos-absolute top-5 cursor-pointer d-flex align-items-center'
				style={{ right: '1.50%' }}>
