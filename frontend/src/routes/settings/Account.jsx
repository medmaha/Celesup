...
export default function Account() {
    ...
    useEffect(() => {
        ...
        // console.log(account)
        // console.log(account.email_privacy)
        setAccount({
            ...account,
            ...data,
        })
    ...
    async function changeEmailPrivacy(ev) {
        const form = new FormData()
        form.append("email_privacy", !account.email_privacy)

        await getAccountData({ method: "PUT", form: form })
    }
                    ...
                    <div className="mb-0 input-field width-100 pt-3">
                                ...
                                >
                                    ...
                                    >
                                        <span className="d-flex align-items-center gap-5-px">
                                            <span>Not visible in emails</span>
                                            <span>
                                                <svg
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24"
                        ...
                        <div className="input-field p-__ border">
                            ...
                            <p className="typography font-sm">
                                ...
                                <span>toure925@outlook.com</span>
